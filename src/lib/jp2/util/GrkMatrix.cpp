 ...
 * Matrix inversion.
 */
bool GrkMatrix::matrix_inversion_f(float *pSrcMatrix, float *pDestMatrix,
		uint32_t nb_compo) {
...
bool GrkMatrix::lupDecompose(float *matrix, uint32_t *permutations,
...
void GrkMatrix::lupSolve(float *pResult, float *pMatrix, float *pVector,
