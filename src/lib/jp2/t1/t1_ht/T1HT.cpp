...
void T1HT::preCompress(CompressBlockInfo *block, grk_tile *tile,
		uint32_t &maximum) {
	(void)block;
	(void)tile;
...
double T1HT::compress(CompressBlockInfo *block, grk_tile *tile, uint32_t maximum,
		bool doRateControl) {
	(void)doRateControl;
	(void)tile;
	(void)maximum;
...
bool T1HT::decompress(DecompressBlockInfo *block) {
	auto cblk = block->cblk;
...
bool T1HT::postDecompress(DecompressBlockInfo *block) {
	auto cblk = block->cblk;
