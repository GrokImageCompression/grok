...
enum J2K_STATUS
{
	...
	J2K_DEC_STATE_TPH 		= 0x0008, /**< the decoding process is in a tile part header */
	J2K_DEC_STATE_TPH_SOT 	= 0x0010, /**< the decoding process is in a tile part header
										 and expects a SOT marker */
	J2K_DEC_STATE_DATA 		= 0x0020, /**< the decoding process is expecting
									  to read tile data from the code stream */
	J2K_DEC_STATE_EOC 		= 0x0040, /**< the decoding process has encountered the EOC marker */
	J2K_DEC_STATE_NO_EOC 	= 0x0080, /**< the decoding process must not expect a EOC marker
