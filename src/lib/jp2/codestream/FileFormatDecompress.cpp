...
void FileFormatDecompress::serializeAsoc(AsocBox *asoc,
...
uint32_t FileFormatDecompress::read_asoc(AsocBox *parent,
								uint8_t **header_data,
...
bool FileFormatDecompress::read_ihdr( uint8_t *p_image_header_data,
...
bool FileFormatDecompress::read_uuid( uint8_t *p_header_data,
...
bool FileFormatDecompress::read_res( uint8_t *p_resolution_data,
...
bool FileFormatDecompress::read_bpc( uint8_t *p_bpc_header_data,
...
bool FileFormatDecompress::read_colr( uint8_t *p_colr_header_data,
