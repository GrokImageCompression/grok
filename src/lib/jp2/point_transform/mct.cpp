...
*/
#endif
	float *GRK_RESTRICT c0 = (float*) tile->comps[compno].getBuffer()->getHighestBufferResWindowREL()->data;
...
void mct::decompress_irrev(grk_tile *tile, GrkImage *image,TileComponentCodingParams *tccps) {
	...
	float *GRK_RESTRICT c0 = (float*) tile->comps[0].getBuffer()->getHighestBufferResWindowREL()->data;
	float *GRK_RESTRICT c1 = (float*) tile->comps[1].getBuffer()->getHighestBufferResWindowREL()->data;
	float *GRK_RESTRICT c2 = (float*) tile->comps[2].getBuffer()->getHighestBufferResWindowREL()->data;
...
void mct::decompress_dc_shift_rev(grk_tile *tile, GrkImage *image,TileComponentCodingParams *tccps, uint32_t compno) {
	size_t i = 0;
	int32_t *GRK_RESTRICT c0 = tile->comps[compno].getBuffer()->getHighestBufferResWindowREL()->data;
...
void mct::decompress_rev(grk_tile *tile, GrkImage *image,TileComponentCodingParams *tccps) {
	size_t i = 0;
	int32_t *GRK_RESTRICT c0 = tile->comps[0].getBuffer()->getHighestBufferResWindowREL()->data;
	int32_t *GRK_RESTRICT c1 = tile->comps[1].getBuffer()->getHighestBufferResWindowREL()->data;
	int32_t *GRK_RESTRICT c2 = tile->comps[2].getBuffer()->getHighestBufferResWindowREL()->data;
