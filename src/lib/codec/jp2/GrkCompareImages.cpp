                                       ...
                                       const char* separator)
{
  ...
  for(fileno = 0; fileno < nbFilenamePGX; fileno++)
  {
    ...
    dest_data[fileno] =
        (int32_t*)malloc((size_t)src_param[fileno].h * src_param[fileno].stride * sizeof(int32_t));
    if(!dest_data[fileno])
    {
                                       ...
                                       const char* separator)
{
  ...
  for(fileno = 0; fileno < nbFilenamePGX; fileno++)
  {
    ...
    dest_data[fileno] = (int32_t*)malloc((size_t)dest_param[fileno].h * dest_param[fileno].stride *
                                         sizeof(int32_t));
    if(!dest_data[fileno])
      goto cleanup;
    memcpy(dest_data[fileno], src->comps->data,
