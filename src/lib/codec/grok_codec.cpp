...
int GRK_CALLCONV grk_codec_compress(int argc, char* argv[], grk_image *in_image, grk_stream_params *out_buffer)
{
	return grk::GrkCompress().main(argc, argv, in_image, out_buffer);
}
