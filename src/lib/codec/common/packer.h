...
template<typename T>
class PlanarToInterleaved
{
public:
  virtual ~PlanarToInterleaved() = default;
  virtual void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
...
template<typename T>
class PlanarToInterleaved1 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved2 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved3 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved4 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved5 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved6 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved7 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved8 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved9 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved10 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved11 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved12 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved13 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved14 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved15 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved16 : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
...
template<typename T>
class PlanarToInterleaved16BE : public PlanarToInterleaved<T>
{
public:
  void interleave(T** src, const uint32_t numPlanes, uint8_t* dest, const uint32_t srcWidth,
                  const uint32_t srcStride, const uint64_t destStride, const uint32_t h,
