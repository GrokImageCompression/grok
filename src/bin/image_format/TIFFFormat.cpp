...
static void convert_tif_3uto32s(const uint8_t* pSrc, int32_t* pDst, size_t length, bool invert);
...
static void convert_tif_15uto32s(const uint8_t* pSrc, int32_t* pDst, size_t length, bool invert);
static void convert_tif_16uto32s(const uint16_t* pSrc, int32_t* pDst, size_t length, bool invert);
