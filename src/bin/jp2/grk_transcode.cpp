...
bool GrkTranscode::parsePrecision(const char *option,
...
char GrkTranscode::nextFile(std::string inputFile, grk_img_fol *inputFolder,
	...
	std::string infilename = inputFolder->imgdirpath
			+ std::string(pathSeparator()) + inputFile;
 ...
 */
/* -------------------------------------------------------------------------- */
int GrkTranscode::parseCommandLine(int argc,
												char **argv,
...
GrkTranscode::GrkTranscode() : storeToDisk(true),
								 imageFormat(nullptr){
}
