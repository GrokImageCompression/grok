...
rm -f $OUT/grk_decompress_fuzzer_seed_corpus.zip $OUT/grk_decompress_mercury_fuzzer_seed_corpus.zip
zip $OUT/grk_decompress_fuzzer_seed_corpus.zip $CONF_DIR/*.jp2 $CONF_DIR/*.j2k $NR_DIR/*.jp2 $NR_DIR/*.j2k
cp $OUT/grk_decompress_fuzzer_seed_corpus.zip $OUT/grk_decompress_mercury_fuzzer_seed_corpus.zip
